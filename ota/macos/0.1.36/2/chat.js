...
export function chatLine(id, s, l) {
    ...
    if (d.type === "result") {
        ...
        s.usage = { tokens: (u.input_tokens ?? 0) + (u.output_tokens ?? 0) + (u.cache_creation_input_tokens ?? 0), cached: u.cache_read_input_tokens ?? 0, usd: typeof d.total_cost_usd === "number" ? d.total_cost_usd : undefined };
...
export const TURN_CAP = 400_000; // 한 턴 토큰 상한(#27 B)
